...
CREATE INDEX idx_request_templates_stage_id ON public.request_templates(stage_id);
...
SET stage_id = (
  CASE 
    ...
    WHEN title ILIKE '%employee%' OR title ILIKE '%hr%' OR title ILIKE '%organization%' OR title ILIKE '%operation%' OR category = 'HR' OR category = 'Operations' THEN 
